...
On the same page as your table of data, include a <form>suitable for adding rows to the table. (It doesn't need to doanything yet.) Include one input element for each column. Use the appropriate input type. Format the form using an appropriate Bootstrap recipe.
